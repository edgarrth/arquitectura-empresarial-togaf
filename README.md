...
Este repo adapta el ADM de TOGAF a un contexto financiero regulado. No intenta copiar todos los entregables posibles de TOGAF; prioriza los documentos que una empresa real necesita para gobernar transformación, modernización tecnológica, seguridad, plataformas y productos digitales.
...
1. Copiar este repo como plantilla.
2. Ajustar el contexto empresarial.
3. Completar inventarios reales de aplicaciones, datos e infraestructura.
4. Registrar decisiones en ADRs.
5. Publicar GitHub Pages.
6. Usar los checklists en comités de arquitectura y revisiones de solución.
